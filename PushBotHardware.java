...

{
...

    {
        ...
        try
        {
            v_servo_controller = hardwareMap.servoController.get ("servo_controller");
        }
        catch (Exception p_exeception)
        {
            m_warning_message ("servo_controller");
            DbgLog.msg (p_exeception.getLocalizedMessage ());

            v_servo_controller = null;
        }
...
//TODO: Put this in autonomous
    void push_beacon (boolean color)
    ...
    //
    /**
     * Manage the aspects of the push beacon servo.
     */
    private Servo v_servo_push_beacon;

    private ServoController v_servo_controller;
